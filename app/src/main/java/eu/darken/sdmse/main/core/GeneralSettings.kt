...
class GeneralSettings @Inject constructor(
    ...
    val oneClickKillAppsEnabled = dataStore.createValue("dashboard.oneclick.killapps.enabled", false)
    val oneClickCacheTrimEnabled = dataStore.createValue("dashboard.oneclick.cachetrim.enabled", false)
    val oneClickVacuumAppsEnabled = dataStore.createValue("dashboard.oneclick.vacuumapps.enabled", false)
    val oneClickPurgeLogsEnabled = dataStore.createValue("dashboard.oneclick.purgelogs.enabled", false)
